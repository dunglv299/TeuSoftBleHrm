...
public class HRPService extends Service {
	...
	public static final UUID HEART_RATE_MEASUREMENT_CHARAC = UUID
			.fromString("00002A37-0000-1000-8000-00805f9b34fb");
	public static final UUID CCC = UUID
			.fromString("00002902-0000-1000-8000-00805f9b34fb");
	public static final UUID BODY_SENSOR_LOCATION = UUID
	...
	public static final UUID MANUFATURE_NAME_STRING = UUID
			.fromString("00002A29-0000-1000-8000-00805f9b34fb");
	public static final UUID ICDL = UUID
	...
	public static final UUID ECG_SERVICE = UUID
			.fromString("0000fec0-0000-1000-8000-00805f9b34fb");
	public static final UUID ecg_start_uuid = UUID
			.fromString("0000fec5-0000-1000-8000-00805f9b34fb");
	public static final UUID ecg_status_uuid = UUID
			.fromString("0000fec2-0000-1000-8000-00805f9b34fb");

	public static final UUID ACC_SERVICE = UUID
			.fromString("0000ffa0-0000-1000-8000-00805f9b34fb");
	public static final UUID acc_enable_uuid = UUID
			.fromString("0000ffa1-0000-1000-8000-00805f9b34fb");
	public static final UUID acc_value_uuid = UUID
			.fromString("0000ffa6-0000-1000-8000-00805f9b34fb");
	...
	private BluetoothGattCallback mGattCallbacks = new BluetoothGattCallback() {
		...
		public void onCharacteristicChanged(
			...
			if (isHeartRateInUINT16(characteristic.getValue()[0])) {
				...
				hrmval = characteristic.getIntValue(
	...
	public void getBodySensorLoc(BluetoothDevice device) {
		...
		BluetoothGattService mHRP = mBluetoothGatt.getService(device,
				HRP_SERVICE);
		if (mHRP == null) {
		...
		BluetoothGattCharacteristic mBSLcharac = mHRP
	...
	public void ResetEnergyExpended(BluetoothDevice device) {
		...
		BluetoothGattCharacteristic mHRCPcharac = mHRP
				.getCharacteristic(HeartRate_ControlPoint);
		if (mHRCPcharac == null) {
	...
	public void read_uuid_read_29(BluetoothDevice device) {
		...
		BluetoothGattCharacteristic mMNS = mDI
				.getCharacteristic(MANUFATURE_NAME_STRING);
		if (mMNS == null) {
	...
	public void startECGRecording(BluetoothDevice device) {
		...
		BluetoothGattService mECG = mBluetoothGatt.getService(device,
				ECG_SERVICE);
		if (mECG == null) {
			Log.e(TAG, "ECG service not found!");
			return;
		}
		BluetoothGattCharacteristic mECGSTcharac = mECG
				.getCharacteristic(ecg_start_uuid);
	...
	public void startACCService(BluetoothDevice device) {
		BluetoothGattService mACC = mBluetoothGatt.getService(device,
				ACC_SERVICE);
		if (mACC == null) {
			Log.e(TAG, "ECG service not found!");
			return;
		}
		BluetoothGattCharacteristic mACCEncharac = mACC
				.getCharacteristic(acc_enable_uuid);
		...
		if (mBluetoothGatt == null)
			return;
		BluetoothGattCharacteristic mACCValcharac = mACC
				.getCharacteristic(acc_value_uuid);
